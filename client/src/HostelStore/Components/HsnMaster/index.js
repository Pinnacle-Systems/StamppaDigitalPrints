...
import { TextInput, CheckBox, ReusableTable, ToggleButton, TextInputNew1 } from "../../../Inputs";
...
export default function Form() {
    ...
    const { data: allData, } = useGetHsnMasterQuery({ params, searchParams: searchValue });
    const {
        data: singleData,
    ...
    const data = {
        id, name, tax, active, companyId: secureLocalStorage.getItem(sessionStorage.getItem("sessionId") + "userCompanyId")
    }
