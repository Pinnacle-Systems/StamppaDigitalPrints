...
const numberToText = require("number-to-words");
...
const PoSummary = ({
  ...
  const { isLoading: isTaxHookDetailsLoading, ...taxDetails } =
    useTaxDetailsHook({ poItems, taxTypeId, discountType, discountValue });
          ...
          <tr className="h-7">
            ...
            <td className="border border-gray-500">
              <input
                ...
                value={taxDetails.overAllDiscountAmount}
              />
            </td>
          </tr>
          <tr className="h-7">
            ...
            <td className="border border-gray-500" colSpan={2}>
              <input
                ...
                className="h-7 w-full text-right"
                value={
                  parseFloat(taxDetails?.sgstAmount) +
                  parseFloat(taxDetails?.cgstAmount)
                }
              />
            </td>
          </tr>
          <tr className="h-7">
            ...
            <td className="border border-gray-500" colSpan={2}>
              <input
                ...
                name="value"
                className="h-7 w-full text-right"
                value={parseFloat(taxDetails?.igstAmount)}
              />
            </td>
          </tr>
          <tr className="h-7">
          ...
          <tr className="h-7">
            ...
            <td className="border border-gray-500" colSpan={2}>
              <input
                ...
                name="value"
                className="h-7 w-full text-right"
                value={parseFloat(taxDetails?.roundOffAmount).toFixed(2)}
              />
            </td>
          </tr>
          {/* <tr className="h-7">
            ...
            <td className="border border-gray-500" colSpan={2}>
              <input
                ...
                className="h-7 w-full text-right"
                value={
                  numberToText.toWords(taxDetails?.netAmount) + " Only"
                }
              />
            </td>
          </tr> */}
